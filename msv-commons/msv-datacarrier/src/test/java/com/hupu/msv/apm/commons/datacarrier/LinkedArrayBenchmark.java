...
public class LinkedArrayBenchmark {
    ...
    public void testArrayCap1000() {
        ArrayList<com.hupu.msv.apm.commons.datacarrier.SampleData> list = new ArrayList<com.hupu.msv.apm.commons.datacarrier.SampleData>();
        for (int i = 0; i < 1000; i++) {
            list.add(new com.hupu.msv.apm.commons.datacarrier.SampleData());
        }
    }
