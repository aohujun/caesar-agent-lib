 ...
 *
 */
package com.hupu.msv.apm.agent.core.plugin.bytebuddy;
...
public class AnnotationTypeNameMatchTest {
    ...
    public void testMatch() throws Exception {
        final ElementMatcher<MethodDescription> matcher = AnnotationTypeNameMatch.isAnnotatedWithType("com.hupu.msv.apm.agent.core.plugin.bytebuddy.Inject");
