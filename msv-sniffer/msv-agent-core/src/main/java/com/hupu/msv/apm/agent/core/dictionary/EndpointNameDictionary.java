...
import com.hupu.msv.apm.network.common.DetectPoint;
import com.hupu.msv.apm.network.register.v2.*;

import static com.hupu.msv.apm.agent.core.conf.Config.Dictionary.ENDPOINT_NAME_BUFFER_SIZE;
...
public enum EndpointNameDictionary {
    ...
    public PossibleFound findOrPrepare4Register(int serviceId, String endpointName,
        ...
        return find0(serviceId, endpointName, isEntry, isExit, false);
    }
