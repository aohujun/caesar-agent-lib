        ...
        try {
            ...
            if (LOGGER != null) {
                if (t instanceof NullPointerException) {
                    ...
                    LOGGER.warn(t, "class[{}] before method[{}] intercept failure", obj.getClass(), method.getName());
                } else {
            ...
            try {
                ...
                if (LOGGER != null) {
                    if(t instanceof NullPointerException){
                        ...
                        LOGGER.warn(t, "class[{}] after method[{}] intercept failure", obj.getClass(), method.getName());
                    }else{
