...
package com.hupu.msv.apm.agent.core.plugin.bootstrap.template;
...
import com.hupu.msv.apm.agent.core.plugin.bootstrap.IBootstrapLog;
import com.hupu.msv.apm.agent.core.plugin.interceptor.enhance.BootstrapInterRuntimeAssist;
import com.hupu.msv.apm.agent.core.plugin.interceptor.enhance.MethodInterceptResult;
import com.hupu.msv.apm.agent.core.plugin.interceptor.enhance.OverrideCallable;
    ...
    public static Object intercept(@Origin Class<?> clazz, @AllArguments Object[] allArguments, @Origin Method method,
        ...
        try {
            ...
            if (t instanceof NullPointerException) {
                LOGGER.warn(t, "class[{}] before static method[{}] intercept failure", clazz, method.getName());
            } else {
        ...
        try {
            ...
            try {
                ...
                if (t instanceof NullPointerException) {
                    ...
                    LOGGER.warn(t, "class[{}] after static method[{}] intercept failure:{}", clazz, method.getName(), t.getMessage());
                } else {
