...
package com.hupu.msv.apm.agent.core.plugin.interceptor.enhance;
...
public class BootstrapInterRuntimeAssist {
    private static final String AGENT_CLASSLOADER_DEFAULT = "com.hupu.msv.apm.agent.core.plugin.loader.AgentClassLoader";
    private static final String DEFAULT_AGENT_CLASSLOADER_INSTANCE = "DEFAULT_LOADER";
    private static final String LOG_MANAGER_CLASS = "com.hupu.msv.apm.agent.core.plugin.bootstrap.BootstrapPluginLogBridge";
