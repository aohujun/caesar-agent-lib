...
package com.hupu.msv.apm.agent.core.dictionary;
...
import com.hupu.msv.apm.network.register.v2.NetAddressMapping;
import com.hupu.msv.apm.network.register.v2.NetAddresses;
import com.hupu.msv.apm.network.register.v2.RegisterGrpc;

import static com.hupu.msv.apm.agent.core.conf.Config.Dictionary.SERVICE_CODE_BUFFER_SIZE;
