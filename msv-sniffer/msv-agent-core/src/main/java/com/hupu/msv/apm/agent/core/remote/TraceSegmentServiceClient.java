...
import com.hupu.msv.apm.commons.datacarrier.DataCarrier;
import com.hupu.msv.apm.commons.datacarrier.buffer.BufferStrategy;
import com.hupu.msv.apm.commons.datacarrier.consumer.IConsumer;
import com.hupu.msv.apm.network.common.Commands;
import com.hupu.msv.apm.network.language.agent.*;
import com.hupu.msv.apm.network.language.agent.v2.TraceSegmentReportServiceGrpc;

import static com.hupu.msv.apm.agent.core.conf.Config.Buffer.*;
import static com.hupu.msv.apm.agent.core.remote.GRPCChannelStatus.CONNECTED;
...
public class TraceSegmentServiceClient implements BootService, IConsumer<TraceSegment>, TracingContextListener, GRPCChannelListener {
    ...
    // 每次上传成功的TraceSegment的数量
    private long segmentUplinkedCounter;
    // 每次上传由于grpc未连接丢弃的TraceSegment的数量
    ...
    //准备阶段，将本身注册到GRPCChannelManager里面
    @Override
    ...
    /**
     *  此服务核心启动方法，agent启动时会调用。
     *
     *  这里会初始化属性，DataCarrier内存队列。设置其缓冲的类型为IF_POSSIBL，
     *  这个在channels类里面有特殊判断，会根据不同的IDataPartitioner最大尝试次数重试.
     *  这里会开一个线程，休眠时间20ms 消费内存队列中的TraceSegment。
     *
     * @throws Throwable
     */
    @Override
