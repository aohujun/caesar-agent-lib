...
import com.hupu.msv.apm.agent.core.context.trace.EntrySpan;
import com.hupu.msv.apm.agent.core.context.trace.ExitSpan;
import com.hupu.msv.apm.agent.core.context.trace.LocalSpan;
import com.hupu.msv.apm.agent.core.context.trace.NoopExitSpan;
import com.hupu.msv.apm.agent.core.context.trace.NoopSpan;
...
import com.hupu.msv.apm.agent.core.context.trace.WithPeerInfo;
import com.hupu.msv.apm.agent.core.dictionary.DictionaryManager;
import com.hupu.msv.apm.agent.core.dictionary.DictionaryUtil;
import com.hupu.msv.apm.agent.core.dictionary.PossibleFound;
        ...
        try {
            if (activeSpanStack.isEmpty() && running && (!isRunningInAsyncMode || asyncSpanCounter.get() == 0)) {
                ...
                if (!segment.hasRef() && segment.isSingleSpanSegment()) {
                    if (!samplingService.trySampling()||!CaesarAgentUtil.isSampled(ContextManager.getGlobalTraceId())) {
