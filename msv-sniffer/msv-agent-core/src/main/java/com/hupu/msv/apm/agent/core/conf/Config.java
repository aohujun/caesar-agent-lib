...
import com.hupu.msv.apm.agent.core.logging.core.LogLevel;
import com.hupu.msv.apm.agent.core.logging.core.LogOutput;
import com.hupu.msv.apm.agent.core.logging.core.WriterFactory;
...
public class Config {
    ...
    public static class Agent {
        ...
        /**
         * 依赖的外部JAR所在的ClassPath
         */
        public static String DEPENDENCY_EXT_CLASS_PATH = "";
    }
    ...
    public static class Logging {
         ...
         *
         * @see com.hupu.msv.apm.agent.core.logging.core.PatternLogger#DEFAULT_CONVERTER_MAP
         */
