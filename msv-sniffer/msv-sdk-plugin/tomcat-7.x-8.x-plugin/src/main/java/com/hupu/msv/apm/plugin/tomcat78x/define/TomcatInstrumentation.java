...
package com.hupu.msv.apm.plugin.tomcat78x.define;
...
public class TomcatInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
     ...
     */
    private static final String INVOKE_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.tomcat78x.TomcatInvokeInterceptor";

    /**
     * The intercept class for "exception" method in the class "org.apache.catalina.core.StandardWrapperValve"
     */
    private static final String EXCEPTION_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.tomcat78x.TomcatExceptionInterceptor";
