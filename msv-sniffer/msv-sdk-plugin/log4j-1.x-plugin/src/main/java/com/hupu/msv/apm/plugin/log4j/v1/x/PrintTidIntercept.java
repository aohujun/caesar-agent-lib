...
package com.hupu.msv.apm.plugin.log4j.v1.x;
...
public class PrintTidIntercept implements InstanceMethodsAroundInterceptor {
    ...
    public Object afterMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, Object ret) throws Throwable {
        if(ContextManager.isActive()) {
            String result = String.class.cast(ret);
            return String.format("[tid:%s] ", LogUtil.getTid(ContextManager.getGlobalTraceId())) + result;
        }
        return ret;
