...
public class ClientOptionsInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ENHANCE_CLASS = "com.lambdaworks.redis.ClientOptions";

    private static final String CLIENT_OPTIONS_CONSTRUCTOR_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.lettuce.v4.ClientOptionsConstructorInterceptor";
