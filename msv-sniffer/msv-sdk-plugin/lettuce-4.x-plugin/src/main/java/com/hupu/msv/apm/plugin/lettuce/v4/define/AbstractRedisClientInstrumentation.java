...
public class AbstractRedisClientInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ENHANCE_CLASS = "com.lambdaworks.redis.AbstractRedisClient";

    private static final String ABSTRACT_REDIS_CLIENT_CONSTRUCTOR_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.lettuce.v4.AbstractRedisClientInterceptor";
        ...
        return new InstanceMethodsInterceptPoint[] {
            new InstanceMethodsInterceptPoint() {
                ...
                public ElementMatcher<MethodDescription> getMethodsMatcher() {
                    return named("setOptions").and(takesArgumentWithType(0, "com.lambdaworks.redis.ClientOptions"));
                }
