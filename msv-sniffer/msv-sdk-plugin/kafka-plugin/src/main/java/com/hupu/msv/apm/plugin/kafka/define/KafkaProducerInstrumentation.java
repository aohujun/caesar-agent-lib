...
public class KafkaProducerInstrumentation extends AbstractKafkaInstrumentation {
    ...
    public static final String INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.kafka.KafkaProducerInterceptor";
    ...
    public static final String CONSTRUCTOR_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.kafka.ProducerConstructorInterceptor";
