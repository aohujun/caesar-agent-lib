...
public class SendCallbackInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ON_SUCCESS_INTERCEPTOR = "com.hupu.msv.apm.plugin.rocketMQ.v4.OnSuccessInterceptor";
    private static final String ON_EXCEPTION_METHOD = "onException";
    private static final String ON_EXCEPTION_INTERCEPTOR = "com.hupu.msv.apm.plugin.rocketMQ.v4.OnExceptionInterceptor";
