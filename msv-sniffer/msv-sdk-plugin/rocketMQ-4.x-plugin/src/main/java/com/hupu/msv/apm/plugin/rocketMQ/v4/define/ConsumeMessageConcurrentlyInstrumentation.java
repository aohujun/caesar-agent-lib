...
import com.hupu.msv.apm.agent.core.plugin.match.HierarchyMatch;
...
public class ConsumeMessageConcurrentlyInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.rocketMQ.v4.MessageConcurrentlyConsumeInterceptor";
