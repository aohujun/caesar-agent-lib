...
package com.hupu.msv.apm.plugin.spring.boot.define;
...
/**
 * @description: 获取jar包版本
 * @author: Aile
 * @create: 2020/03/06 15:44
 */
public class SpringApplicationInstanceInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
     ...
     * Intercept class.
     */
    private static final String INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.spring.boot.SpringApplicationInstanceInterceptor";
        ...
        return new InstanceMethodsInterceptPoint[]{
                new InstanceMethodsInterceptPoint() {
                    ...
                    public ElementMatcher<MethodDescription> getMethodsMatcher() {
                        return named("deduceMainApplicationClass");
                    }
