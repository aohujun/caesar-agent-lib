...
package com.hupu.msv.apm.plugin.spring.resttemplate.async.define;
...
import com.hupu.msv.apm.plugin.spring.resttemplate.async.ResponseCallBackInterceptor;
...
public class ResponseExtractorFutureInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ADD_CALLBACK_INTERCEPTOR = "com.hupu.msv.apm.plugin.spring.resttemplate.async.ResponseCallBackInterceptor";
    private static final String ENHANCE_CLASS = "org.springframework.web.client.AsyncRestTemplate$ResponseExtractorFuture";
    private static final String GET_METHOD_INTERCEPTOR = "com.hupu.msv.apm.plugin.spring.resttemplate.async.FutureGetInterceptor";
