...
package com.hupu.msv.apm.plugin.spring.resttemplate.async;
...
public class FutureGetInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes,
        ...
        ContextManager.createLocalSpan("future/get:" + cacheValues[0], CaesarAgentUtil.isSampled(ContextManager.getGlobalTraceId()));
    }
