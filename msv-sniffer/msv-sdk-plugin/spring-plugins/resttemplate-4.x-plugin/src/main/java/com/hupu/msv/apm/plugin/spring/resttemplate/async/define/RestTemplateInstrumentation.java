...
public class RestTemplateInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String DO_EXECUTE_INTERCEPTOR = "com.hupu.msv.apm.plugin.spring.resttemplate.async.RestExecuteInterceptor";
    private static final String CREATE_REQUEST_METHOD_NAME = "createAsyncRequest";
    private static final String CREATE_REQUEST_INTERCEPTOR = "com.hupu.msv.apm.plugin.spring.resttemplate.async.RestRequestInterceptor";
