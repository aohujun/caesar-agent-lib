...
package com.hupu.msv.apm.plugin.spring.resttemplate.sync.define;
...
public class RestTemplateInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String DO_EXECUTE_INTERCEPTOR = "com.hupu.msv.apm.plugin.spring.resttemplate.sync.RestExecuteInterceptor";
    private static final String HANDLE_REQUEST_METHOD_NAME = "handleResponse";
    private static final String HAND_REQUEST_INTERCEPTOR = "com.hupu.msv.apm.plugin.spring.resttemplate.sync.RestResponseInterceptor";
    private static final String CREATE_REQUEST_METHOD_NAME = "createRequest";
    private static final String CREATE_REQUEST_INTERCEPTOR = "com.hupu.msv.apm.plugin.spring.resttemplate.sync.RestRequestInterceptor";
