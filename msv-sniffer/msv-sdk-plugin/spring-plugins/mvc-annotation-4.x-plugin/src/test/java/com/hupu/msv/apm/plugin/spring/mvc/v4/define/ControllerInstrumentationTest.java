...
public class ControllerInstrumentationTest {
    ...
    public void testGetInstanceMethodsInterceptPoints() throws Throwable {
        ...
        assertThat(methodPoints[0].getMethodsInterceptor(), is("com.hupu.msv.apm.plugin.spring.mvc.commons.interceptor.RequestMappingMethodInterceptor"));
        assertThat(methodPoints[1].getMethodsInterceptor(), is("com.hupu.msv.apm.plugin.spring.mvc.commons.interceptor.RestMappingMethodInterceptor"));
    ...
    public void testGetConstructorsInterceptPoints() throws Throwable {
        ...
        Assert.assertEquals(cip.getConstructorInterceptor(), "com.hupu.msv.apm.plugin.spring.mvc.v4.ControllerConstructorInterceptor");
