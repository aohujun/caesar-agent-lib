...
public class PathMappingCacheTest {
    ...
    public void setUp() throws Exception {
        pathMappingCache = new PathMappingCache("com.hupu.msv.apm.plugin.spring.mvc");
    }
    ...
    public void testAddPathMapping1() throws Throwable {
        ...
        Assert.assertEquals("the two value should be equal", pathMappingCache.findPathMapping(m), "/com.hupu.msv.apm.plugin.spring.mvc/#toString");
