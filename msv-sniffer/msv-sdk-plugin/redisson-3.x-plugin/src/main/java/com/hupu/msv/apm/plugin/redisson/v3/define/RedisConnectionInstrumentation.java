 ...
 * @author zhaoyuguang
 */
public class RedisConnectionInstrumentation extends AbstractRedissonInstrumentation {

    private static final String ENHANCE_CLASS = "org.redisson.client.RedisConnection";

    private static final String REDISSON_METHOD_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.redisson.v3.RedisConnectionMethodInterceptor";
