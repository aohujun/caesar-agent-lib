...
public class HystrixCommandInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.hystrix.v1.HystrixCommandConstructorInterceptor";
        ...
        return new InstanceMethodsInterceptPoint[] {
            new InstanceMethodsInterceptPoint() {
                ...
                @Override public String getMethodsInterceptor() {
                    return "com.hupu.msv.apm.plugin.hystrix.v1.HystrixCommandRunInterceptor";
                }
            ...
            new InstanceMethodsInterceptPoint() {
                ...
                @Override public String getMethodsInterceptor() {
                    return "com.hupu.msv.apm.plugin.hystrix.v1.HystrixCommandGetFallbackInterceptor";
                }
