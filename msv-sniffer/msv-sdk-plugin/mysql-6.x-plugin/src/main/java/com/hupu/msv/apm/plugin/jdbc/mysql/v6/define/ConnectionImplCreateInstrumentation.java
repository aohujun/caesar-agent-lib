...
public class ConnectionImplCreateInstrumentation extends AbstractMysqlInstrumentation {
    ...
    private static final String GET_INSTANCE_NEW_INTERCEPTOR = "com.hupu.msv.apm.plugin.jdbc.mysql.v6.ConnectionCreateNewInterceptor";

    private static final String GET_INSTANCE_OLD_INTERCEPTOR = "com.hupu.msv.apm.plugin.jdbc.mysql.v6.ConnectionCreateOldInterceptor";
