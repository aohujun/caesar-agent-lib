...
import com.hupu.msv.apm.plugin.lettuce.v5.SWBiConsumer;
import com.hupu.msv.apm.plugin.lettuce.v5.SWConsumer;
...
public class AsyncCommandMethodInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes,
        ...
        AbstractSpan span = ContextManager.createLocalSpan(operationName + "/onComplete", CaesarAgentUtil.isSampled(ContextManager.getGlobalTraceId()));
