...
package com.hupu.msv.apm.plugin.log4j.v2.x;
...
import com.hupu.msv.apm.plugin.log.common.LogUtil;

import java.lang.reflect.Method;


public class PrintTidIntercept implements InstanceMethodsAroundInterceptor {
    ...
    public Object afterMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, Object ret) throws Throwable {
        if(ContextManager.isActive()) {
            StringBuilder result = StringBuilder.class.cast(ret);
            StringBuilder sb = new StringBuilder();
            sb.append(String.format("[tid:%s] ", LogUtil.getTid(ContextManager.getGlobalTraceId())));
            sb.append(result);
            return sb;
        }
        return ret;
