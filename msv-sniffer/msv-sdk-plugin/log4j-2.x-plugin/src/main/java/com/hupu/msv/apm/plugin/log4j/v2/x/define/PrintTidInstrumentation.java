...
package com.hupu.msv.apm.plugin.log4j.v2.x.define;
...
public class PrintTidInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.log4j.v2.x.PrintTidIntercept";
    public static final String ENHANCE_CLASS = "org.apache.logging.log4j.core.layout.PatternLayout";
