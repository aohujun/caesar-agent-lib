...
/**
 * this is a bridge for main thread and real request thread which mean hold the {@link com.hupu.msv.apm.agent.core.context.ContextSnapshot} object to be continued
...
public class SessionRequestInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String CONSTRUCTOR_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.httpasyncclient.v4.SessionRequestConstructorInterceptor";
    ...
    private static final String SUCCESS_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.httpasyncclient.v4.SessionRequestCompleteInterceptor";
    private static final String FAIL_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.httpasyncclient.v4.SessionRequestFailInterceptor";
