...
public class JedisClusterInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String CONSTRUCTOR_WITH_LIST_HOSTANDPORT_ARG_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.jedis.v2.JedisClusterConstructorWithListHostAndPortArgInterceptor";
    private static final String METHOD_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.jedis.v2.JedisMethodInterceptor";
    private static final String CONSTRUCTOR_WITH_HOSTANDPORT_ARG_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.jedis.v2.JedisClusterConstructorWithHostAndPortArgInterceptor";
