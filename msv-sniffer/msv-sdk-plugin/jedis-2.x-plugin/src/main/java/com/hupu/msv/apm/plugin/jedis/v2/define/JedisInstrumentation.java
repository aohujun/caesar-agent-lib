...
package com.hupu.msv.apm.plugin.jedis.v2.define;
...
import com.hupu.msv.apm.plugin.jedis.v2.RedisMethodMatch;
...
public class JedisInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String CONSTRUCTOR_WITH_STRING_ARG_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.jedis.v2.JedisConstructorWithStringArgInterceptor";
    private static final String CONSTRUCTOR_WITH_SHARD_INFO_ARG_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.jedis.v2.JedisConstructorWithShardInfoArgInterceptor";
    private static final String CONSTRUCTOR_WITH_HOST_AND_PORT_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.jedis.v2.JedisClusterConstructorWithHostAndPortArgInterceptor";
    private static final String CONSTRUCTOR_WITH_URI_ARG_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.jedis.v2.JedisConstructorWithUriArgInterceptor";
    private static final String JEDIS_METHOD_INTERCET_CLASS = "com.hupu.msv.apm.plugin.jedis.v2.JedisMethodInterceptor";
