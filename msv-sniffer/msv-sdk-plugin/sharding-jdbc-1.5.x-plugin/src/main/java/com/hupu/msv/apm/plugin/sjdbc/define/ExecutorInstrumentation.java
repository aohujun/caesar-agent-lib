...
public class ExecutorInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String EXECUTOR_ENGINE_CONSTRUCTOR_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.sjdbc.define.ExecutorEngineConstructorInterceptor";

    private static final String EXECUTE_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.sjdbc.define.ExecuteInterceptor";
    
    private static final String ASYNC_EXECUTE_INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.sjdbc.define.AsyncExecuteInterceptor";
