...
package com.hupu.msv.apm.plugin.ons.v8.define;
...
public class SendCallbackInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ENHANCE_CLASS = "com.aliyun.openservices.shade.com.alibaba.rocketmq.client.producer.SendCallback";
    private static final String ON_SUCCESS_ENHANCE_METHOD = "onSuccess";
    private static final String ON_SUCCESS_INTERCEPTOR = "com.hupu.msv.apm.plugin.ons.v8.OnSuccessInterceptor";
    private static final String ON_EXCEPTION_METHOD = "onException";
    private static final String ON_EXCEPTION_INTERCEPTOR = "com.hupu.msv.apm.plugin.ons.v8.OnExceptionInterceptor";
        ...
        return new InstanceMethodsInterceptPoint[] {
            new InstanceMethodsInterceptPoint() {
                @Override public ElementMatcher<MethodDescription> getMethodsMatcher() {
                    return named(ON_SUCCESS_ENHANCE_METHOD).and(takesArgumentWithType(0, "com.aliyun.openservices.shade.com.alibaba.rocketmq.client.producer.SendResult"));
                }
