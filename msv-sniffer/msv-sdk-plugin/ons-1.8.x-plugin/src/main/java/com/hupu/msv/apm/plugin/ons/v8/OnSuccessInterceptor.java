 ...
 * {@link com.aliyun.openservices.shade.com.alibaba.rocketmq.client.producer.SendCallback#onSuccess(
 * com.aliyun.openservices.shade.com.alibaba.rocketmq.client.producer.SendResult)}
 * execute.
 *
 * @author zhang xin
 */
public class OnSuccessInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public static final String CALLBACK_OPERATION_NAME_PREFIX = "Ons(RocketMQ)/";
