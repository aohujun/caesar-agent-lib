...
public class MQClientAPIImplInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ASYNC_METHOD_INTERCEPTOR = "com.hupu.msv.apm.plugin.ons.v8.MessageSendInterceptor";
    public static final String UPDATE_NAME_SERVER_INTERCEPT_CLASS = "com.hupu.msv.apm.plugin.ons.v8.UpdateNameServerInterceptor";
