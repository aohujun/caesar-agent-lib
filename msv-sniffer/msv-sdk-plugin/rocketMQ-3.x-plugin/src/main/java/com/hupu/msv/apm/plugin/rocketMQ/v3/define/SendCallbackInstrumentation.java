...
package com.hupu.msv.apm.plugin.rocketMQ.v3.define;
 ...
 * method by using {@link com.hupu.msv.apm.plugin.rocketMQ.v3.OnSuccessInterceptor} and also intercepts {@link
 * com.alibaba.rocketmq.client.producer.SendCallback#onException(Throwable)} by using {@link
 * com.hupu.msv.apm.plugin.rocketMQ.v3.OnExceptionInterceptor}.
 *
 * @author carlvine500
 */
public class SendCallbackInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String ON_SUCCESS_INTERCEPTOR = "com.hupu.msv.apm.plugin.rocketMQ.v3.OnSuccessInterceptor";
    private static final String ON_EXCEPTION_METHOD = "onException";
    private static final String ON_EXCEPTION_INTERCEPTOR = "com.hupu.msv.apm.plugin.rocketMQ.v3.OnExceptionInterceptor";
