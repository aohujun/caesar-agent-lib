 ...
 * com.hupu.msv.apm.plugin.rocketMQ.v3.MessageConcurrentlyConsumeInterceptor}.
 *
 * @author carlvine500
 */
public class ConsumeMessageConcurrentlyInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String INTERCEPTOR_CLASS = "com.hupu.msv.apm.plugin.rocketMQ.v3.MessageConcurrentlyConsumeInterceptor";
